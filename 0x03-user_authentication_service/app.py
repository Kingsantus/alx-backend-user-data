...
def login() -> tuple:
    ...
    # utilize valid_login to check if the password
    # and email are exactly what in the database or abort
...
def update_password():
    """Update the new password using email,
    reset_token and the new password."""
