...
def log_in(email: str, password: str) -> str:
    """Testing loging a user in while testing
    the statuscode and return string"""
...
def log_out(session_id: str) -> None:
    """Testing logging out a user using
    the session_id generated after the login in"""
    cookies = {"session_id": session_id}
...
def update_password(email: str, reset_token: str, new_password: str) -> None:
    """Testing updating user password with
    the token generated from reset password, email and new_password"""
